...
- (void)setIndicatorLengthStyle:(SGIndicatorLengthType)indicatorLengthStyle {
    ...
    } else if (indicatorLengthStyle == SGIndicatorLengthTypeCustom) {
        indicatorViewH = 24;
        indicatorViewY = (self.SG_height - indicatorViewH)/2.0;
    } else {
        indicatorViewW = firstBtn.SG_width;
        indicatorViewX = firstBtn.SG_x;
    }
    
    if (indicatorLengthStyle == SGIndicatorLengthTypeCustom) {
        _indicatorView.layer.masksToBounds = YES;
        _indicatorView.layer.cornerRadius = indicatorViewH/2.0;
        
        [self.scrollView sendSubviewToBack:self.indicatorView];
    } else {
