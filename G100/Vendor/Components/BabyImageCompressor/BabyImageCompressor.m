//
//  BabyImageCompressor.m
//  G100
//
//  Created by yuhanle on 2018/7/20.
//  Copyright © 2018年 Tilink. All rights reserved.
//

#import "BabyImageCompressor.h"

@implementation BabyImageCompressor
                                     ...
                                     block:(DataBlock)DataBlock
{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        NSData *newIMGData = [BabyImageCompressor CompressToDataWithImage:OldImage
                                                                 ShowSize:ShowSize
                                                                 FileSize:FileSize];
...
{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        UIImage *newIMG = [BabyImageCompressor CompressToImageWithImage:OldImage
                                                               ShowSize:ShowSize
                                                               FileSize:FileSize];
        ImgBlock(newIMG);
    });
