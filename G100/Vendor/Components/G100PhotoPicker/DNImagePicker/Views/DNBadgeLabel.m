...
- (void)setTitle:(NSString *)title
{
    ...
    self.frame = CGRectMake(self.dn_left, self.dn_top, (rect.size.width + 9) > 20?(rect.size.width + 9):20, 20);
    self.backGroudView.dn_width = self.dn_width;
    self.backGroudView.dn_height = self.dn_height;
    self.badgeLabel.dn_width = self.dn_width;
    self.badgeLabel.dn_height = self.dn_height;
