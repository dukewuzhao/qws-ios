...
static NSUInteger const kDNImagePickerMaxSeletedNumber = 5;/* 照片最多数量 */
                                     ...
                                     usingBlock:^(ALAssetsGroup *assetsGroup, BOOL *stop)
         {
             ...
             if ([assetsGroupID isEqualToString:propwetyID]) {
                 *stop = YES;
                 ...
                 imageFlowController.pickedCount = self.pickedCount;
                 imageFlowController.maxSeletedNumber = self.maxSeletedNumber;
...
{
    DNAlbumTableViewController *albumTableViewController = [[DNAlbumTableViewController alloc] init];
    albumTableViewController.maxSeletedNumber = self.maxSeletedNumber;
    albumTableViewController.pickedCount = self.pickedCount;
...
- (NSInteger)maxSeletedNumber {
    if (!_maxSeletedNumber) {
        _maxSeletedNumber = kDNImagePickerMaxSeletedNumber;
    }
