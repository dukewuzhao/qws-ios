...
- (CGSize)popUpSizeForString:(NSString *)string
{
    ...
    CGFloat w, h;
    w = ceilf(MAX([_textLabel.text sizeWithFont:_textLabel.font].width, MIN_POPUPVIEW_WIDTH) * POPUPVIEW_WIDTH_PAD);
    h = ceilf(MAX([_textLabel.text sizeWithFont:_textLabel.font].height, MIN_POPUPVIEW_HEIGHT) * POPUPVIEW_HEIGHT_PAD + ARROW_LENGTH);
...
- (void)layoutSubviews
{
    ...
    CGFloat textHeight = [_textLabel.text sizeWithFont:_textLabel.font].height;
