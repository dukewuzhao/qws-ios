...
#define kGPRSColor [UIColor colorWithRed:53/255.0 green:179/255.0 blue:30/255.0 alpha:1.0]
...
- (void)setupView {
    ...
    self.deviceConnectedStatusLabel.font = kSmallFont;
    ...
    self.commandStatusLabel.font = kSmallFont;
...
- (void)mws_completeCommand:(G100RTCommandModel *)command result:(int)result {
    if (_current_command == command.rt_command) {
        NSString *hint = @"正在发送指令...";
