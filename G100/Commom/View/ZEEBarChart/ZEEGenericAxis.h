...
@class ZEEGenericAxis;
@protocol ZEEGenericAxisDelegete <NSObject>
...
@interface ZEEGenericAxis : UIScrollView
...
/** x轴上名称字体大小(默认为10.f) */
@property (nonatomic, strong) UIFont * xLineNameNormalFont;
/** y轴上数值字体大小(默认为10.f) */
@property (nonatomic, strong) UIFont * xLineNameSelectedFont;
/** y轴上数值字体大小(默认为10.f) */
...
@property (nonatomic, weak) id <ZEEGenericAxisDelegete> aDelegate;
