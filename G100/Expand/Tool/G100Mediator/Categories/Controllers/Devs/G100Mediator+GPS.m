...
NSString * const kCTMediatorTargetGPS = @"GPS";

NSString * const kCTMediatorActionNativFetchGPSViewController = @"nativeFetchGPSViewController";

@implementation G100Mediator (GPS)
...
- (UIViewController *)G100Mediator_viewControllerForGPS:(NSString *)userid bikeid:(NSString *)bikeid devid:(NSString *)devid {
    ...
    UIViewController *viewController = [self performTarget:kCTMediatorTargetGPS
                                                    action:kCTMediatorActionNativFetchGPSViewController
                                                    params:params];
